...
import { ArrowRight, FileText, Upload, Search, History } from "lucide-react"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
        <Card className="flex flex-col items-center text-center p-6">
          ...
          <p className="text-muted-foreground mb-4">
            Upload scanned historical documents in various formats including PDF, JPG, and PNG.
          </p>
      ...
      <div className="text-center mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col items-center">
            ...
            <p className="text-muted-foreground">Upload your scanned historical document in PDF, JPG, or PNG format.</p>
          </div>
          <div className="flex flex-col items-center">
            <div className="bg-primary/10 rounded-full p-4 mb-4">
